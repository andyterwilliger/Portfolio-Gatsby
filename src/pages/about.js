...
function About(props){
  ...
  <ReactBootStrap.Card.Body style = {{backgroundColor: '#f5f5dc'}}>
   ...
   <a target = '_blank'href='https://cat-collector-bucket2.s3.amazonaws.com/ANDYTERWILLIGER_RESUME_Dev_2024.pdf' download><ReactBootStrap.Button id='resume-btn'>Download Resume</ReactBootStrap.Button></a>
